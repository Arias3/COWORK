...
class HomeController extends GetxController with GetTickerProviderStateMixin {
  ...
  void editarCurso(Curso curso) {
    ...
    final descripcionEditController = TextEditingController(text: curso.descripcion);
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (index != -1) {
                ...
                dictados[index].descripcion = descripcionEditController.text.trim();
                dictados.refresh();
              }
              Get.back();
              Get.snackbar(
                      ...
                      itemBuilder: (context, index) {
                        return ListTile(
                          ...
                          trailing: IconButton(
                            ...
                            onPressed: () => _eliminarEstudiante(curso, index),
                          ),
                        );
                      },
                    ),
