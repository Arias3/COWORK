  ...
  PreferredSizeWidget _buildAppBar(HomeController controller) {
    return AppBar(
      ...
      actions: [
        ...
        Obx(() => IconButton(
          icon: controller.isLoadingDictados.value || controller.isLoadingInscritos.value
              ? const SizedBox(
                  width: 20,
                  height: 20,
    ...
    return Column(
      ...
      children: [
        ...
        Obx(() {
          ...
          return _buildCursosGrid(controller.dictados, controller, isDictado: true);
        }),
      ],
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        Obx(() {
          ...
          return _buildCursosGrid(controller.inscritos, controller, isDictado: false);
        }),
      ],
    );
  }
