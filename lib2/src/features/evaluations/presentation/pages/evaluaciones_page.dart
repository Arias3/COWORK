...
class _EvaluacionesPageState extends State<EvaluacionesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final evaluaciones = _evaluacionController.evaluacionesPorActividad;
      ...
      floatingActionButton: _modoSeleccion ? null : FloatingActionButton.extended(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (evaluacion.horasRestantes != null &&
                  evaluacion.estaActiva) ...[
                SizedBox(height: 4),
                Row(
                  children: [
                    ...
                    SizedBox(width: 4),
                    Text(
                      'Tiempo restante: ${evaluacion.horasRestantes}h',
                      style: TextStyle(
                        fontSize: 12,
                        color: Colors.orange,
                        fontWeight: FontWeight.w600,
  ...
  Future<void> _eliminarEvaluacionesSeleccionadas() async {
    for (final evaluacionId in _evaluacionesSeleccionadas) {
      try {
        await _evaluacionController.eliminarEvaluacion(
          evaluacionId,
          widget.activity.id!,
        );
      } catch (e) {
  ...
  Future<void> _iniciarEvaluacion(String periodoId) async {
    ...
    if (result == true) {
      await _evaluacionController.iniciarEvaluacion(periodoId);
      await _cargarEvaluaciones();
    }
  }
